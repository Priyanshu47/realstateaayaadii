...
export const Contact = () => {
  return (
    <ContactWrapper>
      ...
      <div>
        <div className="w-full h-64  flex items-center justify-center text-5xl">
          <h3 className="z-50 absolute">Contact Us</h3>
        </div>
      </div>
      <section className="bg-white py-20 lg:px-40 lg:py-[120px] overflow-hidden relative z-10">
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <h2 className="mb-6 p-5 text-[1.5rem] text-center font-bold uppercase">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base p-5 leading-relaxed mb-9 text-body-color">
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 mt-5 text-white transition rounded bg-gray-500 hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
